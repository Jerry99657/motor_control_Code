...
#define QSPI_PARTITION_UI_SETTINGS_END        \
  (QSPI_PARTITION_UI_SETTINGS_OFFSET + QSPI_PARTITION_UI_SETTINGS_SIZE)
#define QSPI_PARTITION_UI_SETTINGS_SLOT_A     QSPI_PARTITION_UI_SETTINGS_OFFSET
#define QSPI_PARTITION_UI_SETTINGS_SLOT_B     \
  (QSPI_PARTITION_UI_SETTINGS_OFFSET + 0x001000U)
...
#error "QSPI UI settings overlap NES metadata"
#endif
