 ...
 * 0x401000 .. 0x7FFFFF  NES ROM image
 *
...
#define QSPI_PARTITION_NES_ROM_SIZE           \
  (W25QXX_FLASH_SIZE_BYTES - QSPI_PARTITION_NES_ROM_OFFSET)
...
#if (QSPI_PARTITION_NES_ROM_END > W25QXX_FLASH_SIZE_BYTES)
#error "QSPI NES ROM partition exceeds W25Q64 capacity"
#endif
